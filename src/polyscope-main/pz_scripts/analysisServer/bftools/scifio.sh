...
SCIFIO_FLAGS="-Xmx$SCIFIO_MAX_MEM -Djava.awt.headless=true"

# Set flag if headless.
#if [ -z "$SCIFIO_HEADLESS" ]
#then
#  # Do not set headless mode
#  SCIFIO_FLAGS="$SCIFIO_FLAGS"
#else
#  SCIFIO_FLAGS="$SCIFIO_FLAGS -Djava.awt.headless=true"
#fi
