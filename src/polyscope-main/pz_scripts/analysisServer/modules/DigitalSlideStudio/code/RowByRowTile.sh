...
#     Max memory and dis 
# 0.7 Read dimension from [Level0] instead of tDescription. If size was 
#     downsampled [Level0] is correct and tDesc. not!
MAXMEM=14288 #in MB
